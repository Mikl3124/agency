                                ...
                                <form action="{{ route('post.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                          ...
                                          <input type="text" name="meta" value="{{ old('meta') }}" class="form-control" placeholder="Meta Data">
                                        </div>
                                        <div class="form-group">
                                          <label for="title">Mots Clés</label>
                                          <input type="text" name="keywords" value="{{ old('keywords') }}" class="form-control" placeholder="mot clé 1, mot clé 2... ">
                                        </div>
                                        <div class="form-group">
