                                ...
                                <div class="card-body">
                                    <form action="{{ route('post.update', [$post->id]) }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                          ...
                                          <input type="text" name="meta" value="{{ $post->meta }}" class="form-control" placeholder="Entrez la meta description">
                                        </div>
                                        <div class="form-group">
                                          <label for="title">Mots-clés</label>
                                          <input type="text" name="keywords" value="{{ $post->keywords }}" class="form-control" placeholder="mot clé 1, mot clé 2...">
                                        </div>
                                        <div class="form-group">
